...
def get_text(message):
  if message.text == '🍀':
       ...
       bot.send_message(message.chat.id, 'Здесь: инструкция по регистрации (https://docs.google.com/document/d/1zZ5hmAe_VFGwtfn5Vnsu6Wcm4KjFOCqPpsKiDo5GNnE/edit?usp=sharing)')
